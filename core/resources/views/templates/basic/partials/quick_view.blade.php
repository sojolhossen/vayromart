    ...
    <div class="col-md-7">
        <div class="product-details">
            ...
            <div class="d-flex gap-2 flex-column">
                <div class="product-add-to-cart d-flex flex-wrap gap-2">
                    ...
                    <button class="btn btn-success btn--sm buyNow flex-shrink-0" data-id="{{ $product->id }}" data-product_type="{{ $product->product_type }}" @disabled(!$product->salePrice()) type="button">@lang('Buy Now')</button>
                </div>
