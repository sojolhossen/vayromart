...
<body class="bg-gray-50 text-gray-900 scroll-smooth">
    ...
    private function compileTemplateTwo($data, $product)
    {
        ...
        // Custom descriptions list as Roadmap Timeline (Color strictly on numbers, line, and tick marks)
        $descriptionsHtml = '';
            ...
            foreach ($data['descriptions'] as $idx => $desc) {
                if (trim($desc)) {
                    ...
                    <div class="relative group">
                        ...
                        <div class="bg-white p-5 sm:p-6 rounded-2xl border border-gray-150 shadow-sm hover:shadow-md transition-all duration-300 flex items-center gap-4 hover:-translate-y-0.5">
                            <span class="w-10 h-10 rounded-xl bg-white border border-gray-200 text-[#f2532c] flex items-center justify-center flex-shrink-0 text-base shadow-inner">
                                <i class="fas fa-check-double text-[#f2532c]"></i>
                            </span>
