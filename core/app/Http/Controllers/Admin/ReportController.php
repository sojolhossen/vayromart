...
class ReportController extends Controller
{
    ...
    public function  salesReport()
    {
        ...
        $logs = Order::isValidOrder()->delivered()->orderBy('id', 'desc')->searchable(['user:username'])->dateFilter()->withSum('orderDetail as total_product', 'quantity')->with('user', 'guest')->paginate(getPaginate());
