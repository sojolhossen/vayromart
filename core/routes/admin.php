...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CategoryController')->name('category.')->prefix('categories')->group(function () {
        ...
        Route::get('download', 'downloadCategories')->name('download');
    });
    ...
    Route::controller('BrandController')->prefix('brands')->name('brand.')->group(function () {
        ...
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('delete/{id}', 'delete')->name('delete');
        Route::get('download', 'downloadBrands')->name('download');
    });
    ...
    Route::controller('AttributeController')->prefix('product-attributes')->name('attribute.')->group(function () {
        ...
        Route::controller('AttributeValueController')->prefix('values')->name('values.')->group(function () {
            Route::get('{id}/all', 'index')->name('index');
            Route::post('save/{id}', 'store')->name('store');
            Route::get('download', 'downloadAttributeValues')->name('download');
        });
    });
    ...
    Route::controller('ProductTypeController')->prefix('product-types')
        ...
        ->group(function () {
            ...
            Route::post('store/{id?}', 'store')->name('store');
            Route::get('download', 'downloadProductTypes')->name('download');
        });
    ...
    Route::prefix('product')->name('products.')->group(function () {
        ...
        Route::controller('ProductController')->group(function () {
            ...
            Route::post('mohasagor-sync/save-credentials', 'mohasagorSaveCredentials')->name('mohasagor.sync.save_credentials');
            Route::get('mohasagor-sync/test-connection', 'mohasagorTestConnection')->name('mohasagor.sync.test_connection');
            Route::get('mohasagor-sync/search', 'mohasagorSearch')->name('mohasagor.sync.search');
            Route::post('mohasagor-sync/import-single', 'mohasagorImportSingle')->name('mohasagor.sync.import_single');
            Route::post('mohasagor-sync/scrape-link', 'mohasagorScrapeLink')->name('mohasagor.sync.scrape_link');
        ...
        Route::controller('ProductImportController')->group(function () {
            Route::get('import', 'bulkImport')->name('import');
            Route::post('store/import', 'storeBulkImport')->name('import.store');
        });

        Route::controller('ProductExportController')->group(function () {
            Route::get('export', 'bulkExport')->name('export');
            Route::post('export/store', 'bulkExportProduct')->name('export.store');
        });
        ...
        Route::controller('ProductReviewController')->name('reviews.')->prefix('reviews')->group(function () {
            Route::get('/', 'reviews')->name('index');
            Route::get('/trashed', 'trashedReviews')->name('trashed');
            Route::post('/{id}', 'reviewDelete')->name('delete');
            Route::get('view/{id}', 'view')->name('view');
            Route::post('review/reply/{id}', 'reviewReply')->name('reply');

            Route::post('review/approve/{id}', 'reviewApprove')->name('approve');
            Route::post('review/reject/{id}', 'reviewReject')->name('reject');
        });
    });
    ...
    // Chatbot Settings & logs
    Route::controller('AdminChatbotController')->prefix('setting/chatbot')->name('setting.chatbot.')->group(function () {
        Route::get('/', 'index')->name('index');
